...
export default {
    ...
    methods: {
		...
		// },
        // preloadAnim() {
        //     const bg = document.querySelector('.bg-preload')
        //     const bgDim = this.getSizePosition(bg);
        //     const pageContainer = document.querySelector('[data-scroll-container]');
        //     // Window sizes.
        //     let winsize;
        //     const calcWinsize = () => winsize = {width: pageContainer.offsetWidth, height: pageContainer.offsetHeight};
        //     calcWinsize();
        ...
        //                 bg.style.transform = 'matrix(0, 0, 0, 0, 0, 0)';
        //             }
        //         });
        //     }
		...
		// 		x: 0,
		// 		y: 0,
		// 		// scaleX: d/bgDim.width,
		// 		scaleY: d/bgDim.height,
        //         onComplete: () => {
        //                 // bg.style.left = '0px';
        //                 // bg.style.top = '0px';
        //                 hide()
